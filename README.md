...
1. FaultHandler: when generating fault with identical error message multiple times, a new entry is visible in the HMI, but the start/end times are not updated